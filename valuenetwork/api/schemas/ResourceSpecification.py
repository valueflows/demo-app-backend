...
class Query(graphene.AbstractType):
    ...
    resource_specification = graphene.Field(ResourceSpecification,
                                            id=graphene.Int())

    resource_specifications = graphene.List(ResourceSpecification)

    #resource_specifications_by_process_category = graphene.List(ResourceClassification,
    #                                                           category=EconomicResourceProcessCategory())

    #resource_specifications_by_action = graphene.List(ResourceClassification,
    #                                                  action=Action())

    #recipes = graphene.List(ResourceClassification)
    ...
    def resolve_facets(self, args, context, info):
